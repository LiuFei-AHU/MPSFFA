...
## Highlights
1. A multiplane and multiscale feature fusion encoder leveraging multiple parallel convolutional layers to effectively integrate features across different spatial planes and scales.  
2. A novel attention mechanism that incorporates clinical assessment scores to dynamically refine the feature weights generated by the encoder.  
3. A feature similarity discriminator enhancing the differentiation of features belonging to distinct classes.
...
- The 3D MRI is resized to 113x137x113
- The demo data will come soon! ⌛
